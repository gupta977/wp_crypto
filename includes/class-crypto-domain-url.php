        ...
        <div class="changelog section-getting-started">
            <div class="feature-section">
                ...
                <div class="wrap">
                    ...
                    <br><br><a class="button button-primary" href="<?php echo admin_url('admin.php?page=crypto_settings&tab=access&section=crypto_access_settings_start'); ?>">Settings</a>
                    <br><br>
                    <b>Tips</b>
                    <ul>
                    ...
                    <hr>
                    <b>Do you know about <a href='<?php echo esc_url('https://web3domain.org/'); ?>' target='_blank'>Web3Domain</a> ? </b><br>
                    <ul>
                        <li>
